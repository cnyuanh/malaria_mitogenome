...
perl MITObim_1.8.pl -start 1 -end 20 -sample $3 -ref AGAM -readpool reads.fastq -maf initial-mapping_assembly/initial-mapping_d_results/initial-mapping_out.maf --paired --pair --clean --trimoverhang &> log
