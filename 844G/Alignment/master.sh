...
#Description: Obtain the assemblies and align
...
#(Refurbish: Edit this line to point to your reference genome and the output of 765G and 16G)
ln -s /path/to/765G/Results/Assembly/Results/A* Alignment/Data/.
ln -s /path/to/16G/Assembly_BAM16G/Results/16G_* Alignment/Data/.
cp /path/to/reference/AGAMB_MTgenome.fasta Results/seqs.fasta #Create the multifasta file and put the reference in

#The structure of the directories is not regular. Make a list of all the directories that are going to reviewed.

species=(16G_arabiensis 16G_melas 16G_quadriannulatus 16G_bamako 16G_gambiae 16G_merus 16G_epiroticus 16G_christyi 16G_bwambae)
...
christyi=(SRS228219)
bwambae=(bwambae1 bwambae3 bwambae4)
